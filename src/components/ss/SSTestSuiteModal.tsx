...
import { MetallizerTestCaseResult, runAllSSTests } from '../../services/ss/ssTestSuite';

interface SSTestSuiteModalProps {
  onClose: () => void;
}

export const SSTestSuiteModal: React.FC<SSTestSuiteModalProps> = ({ onClose }) => {
  const [results, setResults] = useState<MetallizerTestCaseResult[]>(() => runAllSSTests());
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-base font-bold tracking-tight text-white flex items-center space-x-2">
                <span>Secondary Slitter Acceptance Test Suite</span>
              ...
              <p className="text-xs text-slate-400">
                Verifies Section 1–21 Business Rules, Physical Geometry & PS01 Handshake Integration (SS-01 to SS-57)
              </p>
            </div>
          </div>
