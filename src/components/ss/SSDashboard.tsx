...
export const SSDashboard: React.FC<SSDashboardProps> = ({
  orders,
  jumboRolls,
  plans,
  requirements,
  ...
  return (
    <div className="space-y-6" id="ss-dashboard-view">
      {/* Header Banner */}
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-sm text-slate-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="space-y-1">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-xs text-slate-400 font-mono">6" Paper Core · Max 1700mm Deckle · Max 1000mm Dia</span>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            onClick={() => onNavigate('ss-generator')}
          ...
          >
            ...
            <span>Launch SS Studio</span>
          </button>
          <button
            onClick={() => onNavigate('ss-requirements')}
          ...
          <button
            ...
            title="Run SS Acceptance Tests"
          >
            <ShieldCheck className="w-4 h-4" />
            <span>SS Tests (24/24)</span>
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          <div className="flex items-center justify-between text-slate-500 mb-2">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-600">Secondary Slitter Demand</span>
        ...
        {/* Jumbo Inventory */}
        <div 
          onClick={() => onNavigate('ss-inventory')}
          className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs hover:border-purple-300 transition-all cursor-pointer group"
        >
          <div className="flex items-center justify-between text-slate-500 mb-2">
        ...
        {/* Secondary Slitter Plans */}
        <div 
          onClick={() => onNavigate('ss-plans')}
          className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs hover:border-purple-300 transition-all cursor-pointer group"
        >
          <div className="flex items-center justify-between text-slate-500 mb-2">
      ...
      {/* Two-column layout: Active Jumbo Inventory & Recent Secondary Slitter Plans */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs flex flex-col">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100">
            <div>
              ...
              <p className="text-xs text-slate-500">Tracked consumable 6" paper core jumbo rolls in factory stock</p>
            </div>
            <button
              onClick={() => onNavigate('ss-inventory')}
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs flex flex-col">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100">
            <div>
              <h2 className="text-base font-bold text-slate-900">Recent Secondary Slitter Plans</h2>
          ...
          <div className="divide-y divide-slate-100 mt-2 flex-1">
            {plans.length === 0 ? (
              <div className="py-8 text-center text-xs text-slate-500">
                No Secondary Slitter plans generated yet. Open the SS Studio to create optimized runs.
              </div>
            ) : (
          ...
          <div className="pt-3 border-t border-slate-100 mt-auto">
            ...
            >
              ...
              <span>Generate New Secondary Slitter Plan</span>
            </button>
          </div>
        </div>
      </div>
