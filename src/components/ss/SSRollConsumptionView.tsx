...
import { JumboRoll, SSPlan } from '../../types/ss';

interface SSRollConsumptionViewProps {
  jumboRolls: JumboRoll[];
  plans: SSPlan[];
  onOpenPlan: (plan: SSPlan) => void;
}

export const SSRollConsumptionView: React.FC<SSRollConsumptionViewProps> = ({
  jumboRolls,
  plans,
  onOpenPlan,
}) => {
  ...
  return (
    <div className="space-y-6" id="ss-consumption-view">
      {/* Header */}
              ...
              {filteredRolls.length === 0 ? (
                <tr>
                  <td colSpan={10} className="py-12 text-center text-slate-400">
                    No roll consumption history found yet. Execute plans in SS Studio to view consumption records.
                  </td>
                </tr>
              ) : (
