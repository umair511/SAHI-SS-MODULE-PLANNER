...
export const DEFAULT_FILM_COMPATIBILITY_RULES: FilmCompatibilityRule[] = [
  {
    ...
    notes: 'Approved compatible metallized 18µ group. Allows shared upstream PS01 jumbo manufacturing and combined MSL slitting when beneficial.',
  ...
  },
  {
    ...
    notes: 'Approved compatible metallized 20µ group. Allows shared upstream PS01 jumbo manufacturing and combined MSL slitting when beneficial.',
    created_at: '2026-08-22T00:00:00Z',
    updated_at: '2026-08-22T00:00:00Z',
  },
];
